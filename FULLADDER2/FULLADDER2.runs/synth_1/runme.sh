...
HD_PWD='D:/FULLADDER2/FULLADDER2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rippleadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rippleadder.tcl
