...
HD_PWD='D:/FULLADDER2/FULLADDER2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rippleadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rippleadder.tcl -notrace
